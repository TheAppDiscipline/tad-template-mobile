...
If you are a non-programmer, see the step-by-step instructions in the non-programmer setup guide in the vault (sold separately).
```
...
- If it persists, show the error and point the user to the common gate errors note (Windows / local environment section) in the vault (sold separately), or the equivalent for their OS.
...
Full skills catalog: in the vault (Discipline Loop skills library, sold separately).
