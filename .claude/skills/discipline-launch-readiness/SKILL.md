...
- `validate-scorecard.ts` no existe: el template no es post-Wave 3.1. Sugerir actualizar a la version actual o instalar el script manualmente segun la nota "Estado de Implementación" del vault.
