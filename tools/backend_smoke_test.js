...
if (provider === 'SUPABASE') {
    requireCredentials(['EXPO_PUBLIC_SUPABASE_URL', 'EXPO_PUBLIC_SUPABASE_ANON_KEY'])
    try {
...
if (provider === 'FIREBASE') {
    requireCredentials(['EXPO_PUBLIC_FIREBASE_API_KEY', 'EXPO_PUBLIC_FIREBASE_AUTH_DOMAIN', 'EXPO_PUBLIC_FIREBASE_PROJECT_ID', 'EXPO_PUBLIC_FIREBASE_APP_ID'])
    try {
        ensurePackageInstalled({
